...
import com.example.tabexample.adapter.ChatAdapter;
import com.example.tabexample.adapter.FriendAdapter;
import com.example.tabexample.entity.ChatHis;
import com.example.tabexample.entity.FriendInfo;
import com.example.tabexample.listener.TaxiChatManagerListener;
...
public class MainActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		top_add.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								if (joinMultiUserChat(name, roomTitle, pwd) != null) {
									...
									Toast.makeText(MainActivity.this, "输入信息有误",
				...
				// Intent intent1 = new
				// Intent(MainActivity.this,RoomChatActivity.class);
				// intent1.putExtra("name", name);
		...
		chat.setUsername(NewChatActivity.NAME);
		 ...
		 listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					ChatHis chatHis = chatList.get(position);
					FriendInfo info = new FriendInfo();
					info.setUsername(chatHis.getUsername());
	...
	private void initAddress() {
		...
		FriendAdapter adapter = new FriendAdapter(MainActivity.this,
				R.layout.frienditem, friendList);
	...
	public MultiUserChat joinMultiUserChat(String user, String roomsName,
		...
		try {
			...
			Toast.makeText(MainActivity.this, "加入" + roomsName + "成功",
					Toast.LENGTH_SHORT).show();
			// Log.i("MultiUserChat", "会议室【"+roomsName+"】加入成功........");
			return muc;
		} catch (XMPPException e) {
			e.printStackTrace();
			Toast.makeText(MainActivity.this, "加入" + roomsName + "失败",
					Toast.LENGTH_SHORT).show();
